...
('猛兽区观景台','俯瞰猛兽活动区，请保持安静，勿投喂。','/images/scenic-beast-deck.jpg',119.5965,39.9402,'猛兽区','约25分钟','轻松'),
('狮虎园','东北虎、非洲狮等猛兽展示，科普牌示丰富。','/images/scenic-lion-yard.jpg',119.5972,39.9405,'猛兽区','约20分钟','轻松'),
('食草动物区','长颈鹿、斑马等散养展示，适合亲子。','/images/scenic-herbivore-zone.jpg',119.5988,39.9395,'食草区','约35分钟','轻松'),
('长颈鹿互动广场','互动时间以当日公告为准，请排队文明参观。','/images/scenic-giraffe-plaza.jpg',119.5990,39.9392,'食草区','约15分钟','轻松'),
('鸟类表演场','多种珍禽展示，表演场次见广播。','/images/scenic-bird-show.jpg',119.5995,39.9378,'鸟类区','约30分钟','适中'),
('水禽湖','水禽栖息环境观察与拍照。','/images/scenic-waterfowl-lake.jpg',119.5982,39.9375,'鸟类区','约20分钟','轻松');
